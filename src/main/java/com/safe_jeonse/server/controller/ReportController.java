...
import com.safe_jeonse.server.dto.reponse.ReportResponse;
...
public class ReportController {
    ...
    public ResponseEntity<ReportResponse> report(@Valid @ModelAttribute ReportRequest request, BindingResult bindingResult) {
        log.info("file");
